...
// ------------------------------
export const fetchJobsFromRapidAPIJobPostings = async (page: number = 1, pageSize: number = 12): Promise<Job[]> => {
  try {
    ...
    console.error('Error fetching jobs from job-postings1 RapidAPI:', error);
    return [];
  }
};
